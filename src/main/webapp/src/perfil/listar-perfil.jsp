          ...
          <table class="table table-hover table-striped table-bordered display mt-4 text-center">
            ...
            <c:forEach var="perfil" items="${perfilDAO.list}">
              <tr>
                ...
                <td>${perfil.nome}</td>
                <td>
                  <a class="btn btn-outline-danger" href="${pageContext.request.contextPath}/gerenciar_perfil.do?id=${perfil.id}&deletar=true">
                    <img src="${pageContext.request.contextPath}/imagens/lixeira.svg" alt="lixeira dentro de um quadrado vermelho">
                  </a>
                  <a class="btn btn-outline-success" href="${pageContext.request.contextPath}/gerenciar_perfil.do?id=${perfil.id}">
