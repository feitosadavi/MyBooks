...
<div id="carrinho" class="d-flex flex-column align-items-start">
	...
	<c:choose>
		...
		<c:otherwise>
			<div id="resumo-carrinho" class="resumo-carrinho d-flex flex-column align-items-center">
				...
				<div id="agendamento" style="display:none">
					<form action="${pageContext.request.contextPath}/gerenciar_locacao.do" method="POST">

            <input type="date" name="dataColeta">
